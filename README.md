...
3. **Filters** - some of the filters are direct ports from the old __ASP.Net Dynamic Data Futures VS2008 SP1 RTM project__, they do what they say on the tin.
...
6. **Secured Dynamic Data** site with table and column security.
7. **New Project Template** - Menus and all the above features installed out of the box. 
